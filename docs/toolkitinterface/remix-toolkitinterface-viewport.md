...
| **Scatter Brush** | Toggle paint mode for the [scatter brush](../howto/learning-assets.md#scattering-assets) from the viewport toolbar (docked under **Teleport**) or with `Ctrl+B`. Drag to paint onto captured meshes, Shift+drag to erase, and hold B while scrolling to resize the brush.                              |                                                                                                                                                     |
